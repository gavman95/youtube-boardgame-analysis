...
2. [EDA & Insights](#eda-and-insights)
   ...
   2.6.2 [Top 10 videos based on their sentiment scores](#top-10-sent)
   2.6.3 [Inquiries in Comments](#inquiries-in-comments)
   2.6.4 [Decrypto board game](#decrypto)
   2.6.5 [Choosing 2 channels to follow](#choosing-two-channels)
